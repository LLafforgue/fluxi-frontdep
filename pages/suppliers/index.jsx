...
function Suppliers() {
  ...
  useEffect(() => {
    async function fetchSuppliers () {
      try {
        const responseCustomers = await apiFetch("http://localhost:3001/api/suppliers")
    ...
    async function fetchTags() {
      try {
        const responseTags = await apiFetch("http://localhost:3001/api/suppliers/tags")
  ...
  useEffect(() => {
    ...
    const fetchUrl = `http://localhost:3001/api/suppliers?${querySearch}${queryTag}${queryOrder}`;
