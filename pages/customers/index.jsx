...
function Customers() {
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        const responseCustomers = await apiFetch("/api/customers")
    ...
    async function fetchTags() {
      try {
        const responseTags = await apiFetch("/api/customers/tags")
  ...
  useEffect(() => {
    ...
    const fetchUrl = `/api/customers?${querySearch}${queryTag}${queryOrder}`;
